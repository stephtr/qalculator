...
emconfigure ./configure --prefix=${HOME}/opt CPPFLAGS=-I${HOME}/opt/include LDFLAGS=-L${HOME}/opt/lib --without-libcurl --without-icu --enable-compiled-definitions --disable-nls --disable-shared
make
make install
cd ..
